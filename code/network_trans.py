...
class HDRTransformer(nn.Module):
    ...
    def __init__(self, rank, img_size=128, patch_size=1, in_chans=6,
        ...
        self.conv_x1 = nn.Conv2d(8, embed_dim, 3, 1, 1)
        self.conv_x2 = nn.Conv2d(16, embed_dim, 3, 1, 1)
        self.conv_x3 = nn.Conv2d(8, embed_dim, 3, 1, 1)

        self.upscale_x1 = Upscale(embed_dim)
        self.upscale_x2 = Upscale(embed_dim)
        self.upscale_x3 = Upscale(embed_dim)
        ######################################
